...
//        val result = Sodoku.filledSubBoard(parentBoard = mutableListOf(), currentSubBoardIndex = 0)
...
////        3, 7, 6     5, 4, 8     8, 1, 7
//
//        val result = Sodoku.checkRowContainSameNum(dummyBoard, 1, 0, 1)
//        assertEquals(result, true)
//    }
//    @Test
//    fun check_num_in_col_is_valid(){
//        val emptyBoard = listOf<List<Int>>()
////        5, 4, 8,    1, 2, 4,    4, 2, 8,
////        6, 7, 3,    6, 8, 7     7, 9, 5,
////        1, 2, 9     5, 9, 3     1, 3, 6
////
...
////        3, 7, 6     5, 4, 8     8, 1, 7
//
//        val result = Sodoku.checkColumnContainSameNum(emptyBoard, 2, 4, 0)
//        assertEquals(result, true)
//    }
//    @Test
//    fun get_nums_in_row(){
//        val board = listOf(listOf(5, 4, 8, 6, 7, 3, 1, 2, 9))
//
//        val nums = Sodoku.numInSameRow(board, 2, 0)
//        println(nums)
//    }
//
//    @Test
...
//        )
//
//        val nums = Sodoku.numsInSameColumn(board, 1, 2)
//        println(nums)
//    }
//    @Test
//    fun generate_valid_board(){
//        val board = Sodoku.generateBoard()
//        println(board)
//        assertEquals(board.size, 9)
//    }
//
//    @Test
//    fun get_possible_number_in_subboard_from_same_row_column() {
//        val possibleNum = Sodoku.getPossibleNumbersFromRowAndColumn(dummyBoard, 1, 0, 1)
//        println(possibleNum)
//        val set1 = setOf(1,2)
//        val set2 = setOf(2)
//        set1.subtract(set2)
